---
title: 0.1.0-rc.1
description: Release notes for OpenBao Operator 0.1.0-rc.1.
slug: /0.1.0-rc.1
---

<StatusPill>0.1.0-rc.1</StatusPill>
...
This release note is archived, but a matching versioned docs snapshot is not published in this site yet.
  ...
  <LinkCard title="GitHub release" to="https://github.com/dc-tec/openbao-operator/releases/tag/0.1.0-rc.1">
