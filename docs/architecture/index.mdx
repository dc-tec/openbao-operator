...
<RouteList
  ...
  items={[
    ...
    {
      eyebrow: '07',
      title: 'Claim contract pipeline',
      description: 'Maintainer view of catalog resolution, approved contracts, rendered contracts, materialization, and connection publication.',
      docId: 'architecture/service-claims-contract-pipeline',
    },
    {
      eyebrow: '08',
      title: 'Claim boundaries',
      description: 'Module, catalog, day-2 workflow, and fail-closed boundary rules for service-claim development.',
