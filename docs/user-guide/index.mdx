...
<JourneyRail
  ...
  items={[
    ...
    {
      label: 'Choose the provisioning path',
      description: 'Create a direct OpenBaoCluster or publish a service catalog and request OpenBao through OpenBaoClusterClaim.',
