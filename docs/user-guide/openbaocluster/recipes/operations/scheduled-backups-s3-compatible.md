...
!!! tip "Recommended starting point"
    If you do not have a cluster yet, start with [Development Profile with Self-Init and Userpass](../local/development-self-init-userpass.md).
...
- [Development Profile with Self-Init and Userpass](../local/development-self-init-userpass.md)
