...
func defaultOptions(mode string) options {
	return options{
		...
		OpenBaoVersion:     envOrDefault("PERF_OPENBAO_VERSION", "2.6.3"),
		OpenBaoImage:       envOrDefault("PERF_OPENBAO_IMAGE", "openbao/openbao:2.6.3"),
		...
		UpgradeToVersion:   envOrDefault("PERF_UPGRADE_TO_VERSION", "2.6.3"),
		UpgradeToImage:     envOrDefault("PERF_UPGRADE_TO_IMAGE", "openbao/openbao:2.6.3"),
