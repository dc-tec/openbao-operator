...
func defaultOptions(mode string) options {
	return options{
		...
		OpenBaoVersion:     envOrDefault("PERF_OPENBAO_VERSION", "2.5.5"),
		OpenBaoImage:       envOrDefault("PERF_OPENBAO_IMAGE", "openbao/openbao:2.5.5"),
		UpgradeFromVersion: envOrDefault("PERF_UPGRADE_FROM_VERSION", "2.5.4"),
		UpgradeFromImage:   envOrDefault("PERF_UPGRADE_FROM_IMAGE", "openbao/openbao:2.5.4"),
		UpgradeToVersion:   envOrDefault("PERF_UPGRADE_TO_VERSION", "2.5.5"),
		UpgradeToImage:     envOrDefault("PERF_UPGRADE_TO_IMAGE", "openbao/openbao:2.5.5"),
