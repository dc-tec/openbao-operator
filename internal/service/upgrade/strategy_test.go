...
func TestEffectiveStrategy(t *testing.T) {
	tests := []struct {
		...
		{
			name: "initialized rolling cluster stays rolling before status migration",
			cluster: &openbaov1alpha1.OpenBaoCluster{
		...
		{
			name: "initialized blue green cluster stays blue green before status migration",
			cluster: &openbaov1alpha1.OpenBaoCluster{
				Spec: openbaov1alpha1.OpenBaoClusterSpec{
				...
				Status: openbaov1alpha1.OpenBaoClusterStatus{
					Initialized: true,
					BlueGreen:   &openbaov1alpha1.BlueGreenStatus{Phase: openbaov1alpha1.PhaseIdle},
				},
			},
			desired:   openbaov1alpha1.UpdateStrategyRollingUpdate,
			effective: openbaov1alpha1.UpdateStrategyBlueGreen,
