...
type OpenBaoClientFactory func(config openbaoapi.ClientConfig) (portopenbao.ClusterActions, error)

// DefaultOpenBaoClientFactory is the default OpenBao client factory used by upgrade managers.
func DefaultOpenBaoClientFactory(config openbaoapi.ClientConfig) (portopenbao.ClusterActions, error) {
