...
const (
	...
	ReasonGatewayRoutePending              = "GatewayRoutePending"
	ReasonGatewayRouteNotAccepted          = "GatewayRouteNotAccepted"
	ReasonGatewayRouteReferencesUnresolved = "GatewayRouteReferencesUnresolved"
