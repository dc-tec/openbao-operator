"use strict";(self.webpackChunkwebsite=self.webpackChunkwebsite||[]).push([["82572"],{10814(e,t,r){r.r(t),r.d(t,{metadata:()=>s,default:()=>u,frontMatter:()=>a,contentTitle:()=>i,toc:()=>c,assets:()=>l});var s=JSON.parse('{"id":"user-guide/openbaocluster/configuration/network","title":"Network Configuration","description":"Configure the operator-managed NetworkPolicy contract, including DNS, Kubernetes API egress, trusted ingress peers, and external dependency paths for backups and restore.","source":"@site/versioned_docs/version-0.1.0/user-guide/openbaocluster/configuration/network.md","sourceDirName":"user-guide/openbaocluster/configuration","slug":"/user-guide/openbaocluster/configuration/network","permalink":"/openbao-operator/docs/0.1.0/user-guide/openbaocluster/configuration/network","draft":false,"unlisted":false,"editUrl":"https://github.com/dc-tec/openbao-operator/edit/main/docs/user-guide/openbaocluster/configuration/network.md","tags":[],"version":"0.1.0","lastUpdatedBy":"Roel de Cort","lastUpdatedAt":1774904343000,"frontMatter":{"title":"Network Configuration","hide_title":true,"pageType":"task","journey":"configure","description":"Configure the operator-managed NetworkPolicy contract, including DNS, Kubernetes API egress, trusted ingress peers, and external dependency paths for backups and restore."},"sidebar":"operatorDocs","previous":{"title":"External access","permalink":"/openbao-operator/docs/0.1.0/configure/external-access"},"next":{"title":"Gateway API support","permalink":"/openbao-operator/docs/0.1.0/user-guide/openbaocluster/configuration/gateway-api"}}'),o=r(91987),n=r(67008);let a={title:"Network Configuration",hide_title:!0,pageType:"task",journey:"configure",description:"Configure the operator-managed NetworkPolicy contract, including DNS, Kubernetes API egress, trusted ingress peers, and external dependency paths for backups and restore."},i,l={},c=[{value:"DNS and Kubernetes API egress",id:"dns-and-kubernetes-api-egress",level:2},{value:"Add the environment-specific paths",id:"add-the-environment-specific-paths",level:2},{value:"Read the operator conditions",id:"read-the-operator-conditions",level:2}];function d(e){let t={code:"code",h2:"h2",p:"p",...(0,n.R)(),...e.components},{CommandBlock:r,DecisionTable:s,DiagramFrame:a,NextActions:i,PageHeader:l,TabItem:c,Tabs:d}=t;return r||p("CommandBlock",!0),s||p("DecisionTable",!0),a||p("DiagramFrame",!0),i||p("NextActions",!0),l||p("PageHeader",!0),c||p("TabItem",!0),d||p("Tabs",!0),(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(l,{title:"Treat NetworkPolicy as part of the cluster contract, not as an afterthought.",lede:"The operator uses a deny-by-default posture and then adds the ingress and egress paths the cluster needs to function. That means DNS, Kubernetes API access, edge peers, and backup or restore dependencies should be configured intentionally rather than discovered during an outage."}),"\n",(0,o.jsx)(a,{title:"Default network posture",caption:"The namespace starts from deny-by-default, then allows the operator, peer traffic, DNS, Kubernetes API access, and whichever external systems you configure deliberately.",code:`flowchart TB
...
network:
  ...
  dnsEndpointIPs:
    - "169.254.20.10"`,children:(0,o.jsxs)(t.p,{children:["Use ",(0,o.jsx)(t.code,{children:"dnsEndpointIPs"})," only when the resolver is enforced by IP rather than by Service-backed pod traffic. This also affects backup and restore Jobs."]})})}),(0,o.jsx)(c,{value:"api",label:"Kubernetes API",children:(0,o.jsx)(r,{language:"yaml",label:"configure",title:"Pin Kubernetes API egress explicitly when needed",code:`spec:
network:
...
network:
  trustedIngressPeers:
    ...
    - namespaceSelector:
      ...
      podSelector:
        matchLabels:
          app.kubernetes.io/name: traefik`,children:(0,o.jsxs)(t.p,{children:["Use this when the source is a user-managed ingress controller or Gateway data plane. It is usually clearer than writing a raw ",(0,o.jsx)(t.code,{children:"ingressRules"})," block for the same case."]})})}),(0,o.jsx)(c,{value:"egress",label:"External egress",children:(0,o.jsx)(r,{language:"yaml",label:"configure",title:"Allow egress to transit, storage, or other external systems",code:`spec:
network:
  egressRules:
    - to:
        - namespaceSelector:
