"use strict";(self.webpackChunkwebsite=self.webpackChunkwebsite||[]).push([["2350"],{6272(e,t,o){o.r(t),o.d(t,{metadata:()=>a,default:()=>d,frontMatter:()=>s,contentTitle:()=>n,toc:()=>c,assets:()=>l});var a=JSON.parse('{"id":"user-guide/openbaocluster/configuration/self-init","title":"Self-Initialization","description":"Configure bootstrap requests, operator OIDC setup, and verification for self-initializing OpenBao clusters without leaving a persistent root token behind.","source":"@site/versioned_docs/version-0.1.0-rc.5/user-guide/openbaocluster/configuration/self-init.md","sourceDirName":"user-guide/openbaocluster/configuration","slug":"/user-guide/openbaocluster/configuration/self-init","permalink":"/openbao-operator/docs/0.1.0-rc.5/user-guide/openbaocluster/configuration/self-init","draft":false,"unlisted":false,"editUrl":"https://github.com/dc-tec/openbao-operator/edit/main/docs/user-guide/openbaocluster/configuration/self-init.md","tags":[],"version":"0.1.0-rc.5","lastUpdatedBy":"Roel de Cort","lastUpdatedAt":1774542744000,"frontMatter":{"title":"Self-Initialization","hide_title":true,"pageType":"task","journey":"configure","description":"Configure bootstrap requests, operator OIDC setup, and verification for self-initializing OpenBao clusters without leaving a persistent root token behind."},"sidebar":"operatorDocs","previous":{"title":"Security profiles","permalink":"/openbao-operator/docs/0.1.0-rc.5/configure/security-profiles"},"next":{"title":"Server configuration","permalink":"/openbao-operator/docs/0.1.0-rc.5/user-guide/openbaocluster/configuration/server"}}'),r=o(74848),i=o(28453);let s={title:"Self-Initialization",hide_title:!0,pageType:"task",journey:"configure",description:"Configure bootstrap requests, operator OIDC setup, and verification for self-initializing OpenBao clusters without leaving a persistent root token behind."},n,l={},c=[{value:"Enable self-init",id:"enable-self-init",level:2},{value:"What belongs in <code>requests</code>",id:"what-belongs-in-requests",level:2},{value:"Bootstrap operator OIDC roles",id:"bootstrap-operator-oidc-roles",level:2},{value:"Common bootstrap patterns",id:"common-bootstrap-patterns",level:2},{value:"Verify the cluster finished bootstrap",id:"verify-the-cluster-finished-bootstrap",level:2}];function u(e){let t={code:"code",h2:"h2",p:"p",...(0,i.R)(),...e.components},{Callout:o,CommandBlock:a,DecisionTable:s,DiagramFrame:n,NextActions:l,PageHeader:c,TabItem:u,Tabs:d}=t;return o||p("Callout",!0),a||p("CommandBlock",!0),s||p("DecisionTable",!0),n||p("DiagramFrame",!0),l||p("NextActions",!0),c||p("PageHeader",!0),u||p("TabItem",!0),d||p("Tabs",!0),(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c,{title:"Bootstrap the cluster declaratively and avoid carrying a root token forward.",lede:"Self-initialization lets the cluster bring up auth methods, policies, audit devices, and other bootstrap state as part of the `OpenBaoCluster` manifest. It is the supported production bootstrap path because it avoids leaving a long-lived root token in a Kubernetes Secret."}),"\n",(0,r.jsx)(s,{title:"Choose the bootstrap path deliberately",columns:["Path","Use it when","What happens to the root token","Watch for"],rows:[{cells:["Self-initialization","You want declarative bootstrap and a production-ready baseline.","The root token is auto-revoked after the requests complete successfully.","You must define at least one usable auth path for humans or automation before the cluster comes up."],emphasis:"recommended"},{cells:["Standard init","You need a temporary compatibility path for development or controlled manual setup.","A root token can be created and stored in a Secret.","This is easier to start with, but it leaves you with a stronger credential-management burden afterward."],emphasis:"caution"}]}),"\n",(0,r.jsx)(n,{title:"Self-init bootstrap flow",caption:"The cluster initializes, applies the declared requests, and then revokes the bootstrap credential instead of treating it as a permanent operating dependency.",code:`flowchart LR
...
authMethod:
  ...
  config:
    ...
    max_lease_ttl: "24h"`})}),(0,r.jsx)(u,{value:"policy",label:"Policy",children:(0,r.jsx)(a,{language:"yaml",label:"configure",title:"Create an ACL policy at bootstrap",code:`- name: app-policy
operation: update
...
policy:
  policy: |
    ...
    }`})}),(0,r.jsx)(u,{value:"secret-engine",label:"Secret engine",children:(0,r.jsx)(a,{language:"yaml",label:"configure",title:"Enable a KV v2 mount",code:`- name: enable-kv-v2
operation: update
