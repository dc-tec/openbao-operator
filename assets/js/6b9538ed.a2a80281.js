...
network:
  trustedIngressPeers:
    ...
    - namespaceSelector:
      ...
      podSelector:
        matchLabels:
          app.kubernetes.io/name: traefik`,children:(0,o.jsx)(t.p,{children:"Use this when the source is a user-managed ingress controller, Gateway data plane, or another explicit application access path. Hardened clusters require these peers to select concrete sources; empty or wildcard peer selectors are rejected."})})}),(0,o.jsx)(c,{value:"egress",label:"External egress",children:(0,o.jsx)(r,{language:"yaml",label:"configure",title:"Allow egress to transit, storage, or other external systems",code:`spec:
network:
  egressRules:
    - to:
        - namespaceSelector:
    ...
    - to:
      ...
      ports:
        - protocol: TCP
          port: 443`,children:(0,o.jsx)(t.p,{children:"Use this for transit unseal, object storage, private PKI, or any other external dependency that should not be reachable through a broad allow-all rule. Hardened clusters require every user-provided egress rule to have explicit peers and ports."})})}),(0,o.jsx)(c,{value:"ingress",label:"Raw ingress rules",children:(0,o.jsx)(r,{language:"yaml",label:"configure",title:"Add a raw ingress rule outside Hardened",code:`spec:
network:
  ingressRules:
    - from:
        - namespaceSelector:
