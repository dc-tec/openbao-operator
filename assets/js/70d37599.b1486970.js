...
-o jsonpath='{.status.backup.lastBackupName}{"\\n"}{.status.backup.lastBackupTime}{"\\n"}{.status.backup.lastFailureReason}{"\\n"}'`}),"\n",(0,s.jsx)(l,{title:"Keep moving",items:[{label:"Reference architecture",description:"Review the hardened lane summary, topology, and invariants behind this cloud baseline.",docId:"user-guide/validated-deployments/architectures/cloud/amazon-eks-hardened-awskms-acme"},{label:"Troubleshoot the cluster",description:"Use the generic incident routing page if ACME, Gateway, or KMS readiness fails to settle.",docId:"user-guide/openbaocluster/operations/troubleshooting"},{label:"Backup operations",description:"Return to the operator-wide backup guide for retention and restore planning beyond this validated lane.",docId:"user-guide/openbaocluster/operations/backups"}]})]})}function p(e={}){let{wrapper:a}={...(0,o.R)(),...e.components};return a?(0,s.jsx)(a,{...e,children:(0,s.jsx)(c,{...e})}):c(e)}function u(e,a){throw Error("Expected "+(a?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}},28453(e,a,t){t.d(a,{R:()=>r,x:()=>l});var n=t(96540);let s={},o=n.createContext(s);function r(e){let a=n.useContext(o);return n.useMemo(function(){return"function"==typeof e?e(a):{...a,...e}},[a,e])}function l(e){let a;return a=e.disableParentContext?"function"==typeof e.components?e.components(s):e.components||s:r(e.components),n.createElement(o.Provider,{value:a},e.children)}}}]);