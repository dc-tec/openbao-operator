"use strict";(self.webpackChunkwebsite=self.webpackChunkwebsite||[]).push([["51177"],{64976(e,t,a){a.r(t),a.d(t,{metadata:()=>o,default:()=>u,frontMatter:()=>s,contentTitle:()=>n,toc:()=>c,assets:()=>l});var o=JSON.parse('{"id":"user-guide/openbaocluster/configuration/self-init","title":"Self-Initialization","description":"Configure bootstrap requests, operator OIDC setup, and verification for self-initializing OpenBao clusters with an auto-revoked bootstrap credential.","source":"@site/versioned_docs/version-0.4.0/user-guide/openbaocluster/configuration/self-init.md","sourceDirName":"user-guide/openbaocluster/configuration","slug":"/user-guide/openbaocluster/configuration/self-init","permalink":"/openbao-operator/docs/0.4.0/user-guide/openbaocluster/configuration/self-init","draft":false,"unlisted":false,"editUrl":"https://github.com/dc-tec/openbao-operator/edit/main/docs/user-guide/openbaocluster/configuration/self-init.md","tags":[],"version":"0.4.0","lastUpdatedBy":"Roel de Cort","lastUpdatedAt":1783172994000,"frontMatter":{"title":"Self-Initialization","hide_title":true,"pageType":"task","journey":"configure","description":"Configure bootstrap requests, operator OIDC setup, and verification for self-initializing OpenBao clusters with an auto-revoked bootstrap credential."},"sidebar":"operatorDocs","previous":{"title":"Security profiles","permalink":"/openbao-operator/docs/0.4.0/configure/security-profiles"},"next":{"title":"Unseal configuration","permalink":"/openbao-operator/docs/0.4.0/configure/unseal"}}'),r=a(91987),i=a(82681);let s={title:"Self-Initialization",hide_title:!0,pageType:"task",journey:"configure",description:"Configure bootstrap requests, operator OIDC setup, and verification for self-initializing OpenBao clusters with an auto-revoked bootstrap credential."},n,l={},c=[{value:"Enable self-init",id:"enable-self-init",level:2},{value:"Create initial recovery keys",id:"create-initial-recovery-keys",level:2},{value:"What belongs in <code>requests</code>",id:"what-belongs-in-requests",level:2},{value:"Bootstrap operator OIDC roles",id:"bootstrap-operator-oidc-roles",level:2},{value:"Common bootstrap patterns",id:"common-bootstrap-patterns",level:2},{value:"Verify the cluster finished bootstrap",id:"verify-the-cluster-finished-bootstrap",level:2}];function d(e){let t={a:"a",code:"code",h2:"h2",p:"p",...(0,i.R)(),...e.components},{Callout:a,CommandBlock:o,DecisionTable:s,DiagramFrame:n,NextActions:l,PageHeader:c,TabItem:d,Tabs:u}=t;return a||p("Callout",!0),o||p("CommandBlock",!0),s||p("DecisionTable",!0),n||p("DiagramFrame",!0),l||p("NextActions",!0),c||p("PageHeader",!0),d||p("TabItem",!0),u||p("Tabs",!0),(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c,{title:"Declarative cluster bootstrap",lede:"Self-initialization applies auth methods, policies, audit devices, and other bootstrap state from the `OpenBaoCluster` manifest and then revokes the bootstrap root token. Use this page to configure the bootstrap contract and the access paths that must exist after initialization."}),"\n",(0,r.jsx)(s,{title:"Choose the bootstrap path deliberately",columns:["Path","Use it when","What happens to the root token","Watch for"],rows:[{cells:["Self-initialization","You want declarative bootstrap and a production-ready baseline.","The root token is auto-revoked after the requests complete successfully.","You must define at least one usable auth path for humans or automation before the cluster comes up."],emphasis:"recommended"},{cells:["Standard init","You need a temporary compatibility path for development or controlled manual setup.","A root token can be created and stored in a Secret.","This is easier to start with, but it leaves you with a stronger credential-management burden afterward."],emphasis:"caution"}]}),"\n",(0,r.jsx)(n,{title:"Self-init bootstrap flow",caption:"The cluster initializes, applies the declared requests, and then revokes the bootstrap credential instead of treating it as a permanent operating dependency.",code:`flowchart LR
  ...
  class Auth,Audit,Ready write;`}),"\n",(0,r.jsx)(a,{type:"warning",title:"Plan the access path before enabling self-init",children:(0,r.jsx)(t.p,{children:"If self-init is enabled and no usable auth method exists for operators or humans, the root token is revoked and the cluster can become effectively unreachable unless it is recreated."})}),"\n",(0,r.jsx)(s,{title:"Bootstrap both access surfaces together",columns:["Access surface","Where it lives","What must be true before first reconcile"],rows:[{cells:["Operator lifecycle auth","`spec.selfInit.oidc.enabled`","Enable it when you want the operator to bootstrap JWT auth for backup, restore, and upgrade work."],emphasis:"recommended"},{cells:["Human login path","`spec.selfInit.requests`","Create at least one usable auth method and policy path for people before the root token is revoked."]},{cells:["Initial recovery keys","`spec.recoveryKeys.initial`","Declare the OpenPGP recipients, share count, and threshold when auto-unseal clusters need recovery keys created during self-init."]}]}),"\n",(0,r.jsx)(a,{type:"tip",title:"Define operator and human access in the same bootstrap contract",children:(0,r.jsxs)(t.p,{children:["If the cluster will self-initialize, define the human login path in ",(0,r.jsx)(t.code,{children:"selfInit.requests"})," as part of the same manifest that enables operator auth."]})}),"\n",(0,r.jsx)(t.h2,{id:"enable-self-init",children:"Enable self-init"}),"\n",(0,r.jsx)(o,{language:"yaml",label:"configure",title:"Start from the minimum self-init block",code:`spec:
selfInit:
  enabled: true
  requests:
    - name: enable-audit
...
authMethod:
  ...
  config:
    ...
    max_lease_ttl: "24h"`})}),(0,r.jsx)(d,{value:"policy",label:"Policy",children:(0,r.jsx)(o,{language:"yaml",label:"configure",title:"Create an ACL policy at bootstrap",code:`- name: app-policy
operation: update
...
policy:
  policy: |
    ...
    }`})}),(0,r.jsx)(d,{value:"secret-engine",label:"Secret engine",children:(0,r.jsx)(o,{language:"yaml",label:"configure",title:"Enable a KV v2 mount",code:`- name: enable-kv-v2
operation: update
...
secretEngine:
  ...
  options:
    version: "2"`})}),(0,r.jsx)(d,{value:"audit-device",label:"Audit device",children:(0,r.jsx)(o,{language:"yaml",label:"configure",title:"Enable audit logging at bootstrap",code:`- name: enable-file-audit
operation: update
path: sys/audit/file
auditDevice:
  type: file
  fileOptions:
    filePath: /var/log/openbao/audit.log`})})]}),"\n",(0,r.jsx)(t.h2,{id:"verify-the-cluster-finished-bootstrap",children:"Verify the cluster finished bootstrap"}),"\n",(0,r.jsx)(o,{language:"bash",label:"verify",title:"Check the self-init status bit",code:"kubectl get openbaocluster <name> -o jsonpath='{.status.selfInitialized}'",children:(0,r.jsxs)(t.p,{children:["A healthy bootstrap should report ",(0,r.jsx)(t.code,{children:"true"}),". If it does not, inspect the cluster status conditions and controller logs before retrying with additional requests."]})}),"\n",(0,r.jsx)(l,{title:"Continue cluster baseline",items:[{label:"Server configuration",description:"Move from bootstrap into the steady-state server settings and autopilot defaults you want to keep.",docId:"user-guide/openbaocluster/configuration/server"},{label:"Operator authentication",description:"Review the operator-side auth contract if you are relying on OIDC bootstrap.",docId:"user-guide/operator/authn"},{label:"Backup operations",description:"See how the operator OIDC role is used by later lifecycle workflows.",docId:"user-guide/openbaocluster/operations/backups"}]})]})}function u(e={}){let{wrapper:t}={...(0,i.R)(),...e.components};return t?(0,r.jsx)(t,{...e,children:(0,r.jsx)(d,{...e})}):d(e)}function p(e,t){throw Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}},82681(e,t,a){a.d(t,{R:()=>s,x:()=>n});var o=a(71763);let r={},i=o.createContext(r);function s(e){let t=o.useContext(i);return o.useMemo(function(){return"function"==typeof e?e(t):{...t,...e}},[t,e])}function n(e){let t;return t=e.disableParentContext?"function"==typeof e.components?e.components(r):e.components||r:s(e.components),o.createElement(i.Provider,{value:t},e.children)}}}]);