  ...
  requests:
    - name: enable-audit
      ...
      auditDevice:
        type: file
        fileOptions:
          filePath: /tmp/audit.log`,children:(0,s.jsxs)(t.p,{children:[(0,s.jsx)(t.code,{children:"requests"})," defines the bootstrap state. Include the minimum auth, policy, and audit configuration the cluster needs immediately after initialization."]})}),"\n",(0,s.jsx)(a,{language:"yaml",label:"configure",title:"Pair operator OIDC bootstrap with a human auth path",code:`spec:
selfInit:
  enabled: true
  oidc:
    enabled: true
