"use strict";(self.webpackChunkwebsite=self.webpackChunkwebsite||[]).push([["65981"],{34604(e,t,o){o.r(t),o.d(t,{metadata:()=>a,default:()=>d,frontMatter:()=>i,contentTitle:()=>n,toc:()=>c,assets:()=>l});var a=JSON.parse('{"id":"user-guide/operator/authz","title":"Operator Authorization","description":"Policy surfaces for controller, backup, restore, and upgrade work, with destructive capabilities scoped to the right identities.","source":"@site/versioned_docs/version-0.4.0/user-guide/operator/authz.md","sourceDirName":"user-guide/operator","slug":"/get-started/operator-authorization","permalink":"/openbao-operator/docs/get-started/operator-authorization","draft":false,"unlisted":false,"editUrl":"https://github.com/dc-tec/openbao-operator/edit/main/docs/user-guide/operator/authz.md","tags":[],"version":"0.4.0","lastUpdatedBy":"Roel de Cort","lastUpdatedAt":1783172994000,"frontMatter":{"title":"Operator Authorization","description":"Policy surfaces for controller, backup, restore, and upgrade work, with destructive capabilities scoped to the right identities.","slug":"/get-started/operator-authorization","hide_title":true,"pageType":"concept","journey":"get-started"},"sidebar":"operatorDocs","previous":{"title":"Operator authentication","permalink":"/openbao-operator/docs/get-started/operator-authentication"},"next":{"title":"Tenancy & Governance","permalink":"/openbao-operator/docs/tenant-onboarding"}}'),r=o(74848),s=o(28453);let i={title:"Operator Authorization",description:"Policy surfaces for controller, backup, restore, and upgrade work, with destructive capabilities scoped to the right identities.",slug:"/get-started/operator-authorization",hide_title:!0,pageType:"concept",journey:"get-started"},n,l={},c=[{value:"Default policy surfaces",id:"default-policy-surfaces",level:2},{value:"Policy upgrade notes",id:"policy-upgrade-notes",level:2},{value:"Official OpenBao background",id:"official-openbao-background",level:2}];function p(e){let t={a:"a",code:"code",h2:"h2",li:"li",p:"p",ul:"ul",...(0,s.R)(),...e.components},{Callout:o,CommandBlock:a,DecisionTable:i,DiagramFrame:n,NextActions:l,PageHeader:c,TabItem:p,Tabs:d}=t;return o||u("Callout",!0),a||u("CommandBlock",!0),i||u("DecisionTable",!0),n||u("DiagramFrame",!0),l||u("NextActions",!0),c||u("PageHeader",!0),p||u("TabItem",!0),d||u("Tabs",!0),(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(c,{title:"Operator authorization surfaces",lede:"Use separate policy surfaces for controller, backup, restore, and upgrade work. Each path authenticates separately and receives only the capabilities it needs."}),"\n",(0,r.jsx)(n,{title:"Policies stay attached to job-specific identities",caption:"Each operator path maps to its own JWT role and policy set, with separate controller, backup, restore, and upgrade identities.",code:`graph LR
