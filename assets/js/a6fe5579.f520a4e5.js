...
metadata:
name: openbao-admin
namespace: <namespace>`}),"\n",(0,o.jsx)(n,{language:"bash",label:"verify",title:"Wait for tenant provisioning",code:"kubectl -n <operator-namespace> describe openbaotenant <cluster-name>-tenant",children:(0,o.jsxs)(a.p,{children:["The steady-state expectation is ",(0,o.jsx)(a.code,{children:"Provisioned=True"}),"."]})}),"\n",(0,o.jsx)(a.h2,{id:"step-2-apply-the-validated-eks-development-cluster",children:"Step 2: Apply the validated EKS development cluster"}),"\n",(0,o.jsx)(n,{language:"yaml",label:"apply",title:"Apply the Development-profile EKS manifest",code:`apiVersion: openbao.org/v1alpha1
kind: OpenBaoCluster
metadata:
name: <cluster-name>
namespace: <namespace>
