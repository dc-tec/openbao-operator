...
operatorImageVerification:
  enabled: true
  failurePolicy: Block`,children:(0,r.jsx)(t.p,{children:"Hardened is the supported production path. It assumes an external trust source for unseal, non-operator-managed TLS, and a self-initializing bootstrap flow."})})}),(0,r.jsx)(u,{value:"development",label:"Development",children:(0,r.jsx)(o,{language:"yaml",label:"configure",title:"Use the lightest safe evaluation baseline",code:`apiVersion: openbao.org/v1alpha1
kind: OpenBaoCluster
metadata:
name: dev-cluster
spec:
...
unseal:
  ...
  awskms:
    ...
    region: "us-east-1"`})}),(0,r.jsx)(u,{value:"gcp-kms",label:"GCP KMS",children:(0,r.jsx)(o,{language:"yaml",label:"configure",title:"Use GCP Cloud KMS for Hardened unseal",code:`spec:
profile: Hardened
serviceAccount:
  annotations:
...
unseal:
  ...
  gcpCloudKMS:
    ...
    cryptoKey: "openbao-key"`})}),(0,r.jsx)(u,{value:"azure-kv",label:"Azure Key Vault",children:(0,r.jsx)(o,{language:"yaml",label:"configure",title:"Use Azure Key Vault for Hardened unseal",code:`spec:
profile: Hardened
serviceAccount:
  annotations:
...
unseal:
  ...
  azureKeyVault:
    vaultName: "my-vault"
    keyName: "openbao-key"`})}),(0,r.jsx)(u,{value:"transit",label:"Transit",children:(0,r.jsx)(o,{language:"yaml",label:"configure",title:"Use a central OpenBao transit key for unseal",code:`spec:
profile: Hardened
unseal:
  type: transit
