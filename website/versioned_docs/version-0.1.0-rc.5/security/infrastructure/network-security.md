...
<Tabs groupId="ingress-incoming-egress-outgoing">

<TabItem value="ingress-incoming" label="Ingress (Incoming)">
...
<Callout type="warning" title="Custom Ingress">
...
<TabItem value="egress-outgoing" label="Egress (Outgoing)">
...
<Callout type="note" title="Backup and Restore Jobs">
...
- [Network Configuration](../../user-guide/openbaocluster/configuration/network.md)
