...
<Callout type="abstract" title="Immutable Assurance">
...
<Tabs groupId="image-verification-digest-pinning">

<TabItem value="image-verification" label="Image Verification">

The Operator uses **[Cosign](https://github.com/sigstore/cosign)** to verify signatures.
...
<Callout type="danger" title="Private Keys">
...
<Callout type="tip" title="Keyless Defaults for Official Images">
...
<Callout type="note" title="Legacy + Bundle Support">
...
<TabItem value="digest-pinning" label="Digest Pinning">
...
<Callout type="success" title="Immutability">
...
<Callout type="note" title="Scope of Admission Policy">
...
By default, the Operator verifies signatures against the [Sigstore Rekor](https://docs.sigstore.dev/rekor/overview/) transparency log.
...
<Callout type="note" title="Air-Gapped Environments">
...
<Callout type="warning" title="Hardened Profile Guardrails">
...
<Callout type="important" title="No Fallback Behavior">
...
<Tabs groupId="verify-operator-images-verify-helm-chart-oci-verify-release-checksums">

<TabItem value="verify-operator-images" label="Verify Operator Images">
...
<TabItem value="verify-helm-chart-oci" label="Verify Helm Chart (OCI)">
...
<TabItem value="verify-release-checksums" label="Verify Release Checksums">
...
For contributor-facing policy and release evidence requirements, see [Supply Chain Security (Contributing)](/contribute/supply-chain-security).
