...
<DecisionTable
  ...
  rows={[
    ...
    {
      cells: ['Provisioner', 'Reconciles OpenBaoTenant onboarding and namespace scaffolding.', 'Tenant guardrails belong to Day 0 provisioning, not to the cluster workload loop.'],
    },
  ]}
/>
