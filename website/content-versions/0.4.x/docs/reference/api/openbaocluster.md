---
title: OpenBaoCluster API
description: Fields, defaults, and validation for the OpenBaoCluster API.
eyebrow: Reference · Generated API
weight: 1
verifiedBy:
  - api/v1alpha1 at 0.4.2
  - docs/reference/api.md at 0.4.2
  - internal/service/workloadidentity/readiness.go at 0.4.2
  - internal/app/openbaocluster/deletionops/handler.go at 0.4.2
  - internal/platform/openbaotls/validation.go at 0.4.2
---
...
_Appears in:_
- [BackupSchedule](#backupschedule)
- [RestoreSource](../openbaorestore/#restoresource)
...
| `DeleteAll` | DeletionPolicyDeleteAll currently deletes StatefulSets and PVCs.<br />External backup deletion is not implemented in 0.4.2; remove those objects explicitly. |
...
via self-init requests. This replaces the need for raw JSON in the Data field.
See: https://openbao.org/api-docs/system/policy/
...
| `extraSANs` _string array_ | ExtraSANs lists additional subject alternative names required in server certificates.<br />OperatorManaged includes them in generated certificates; External validates them against the supplied certificate. |  | Optional: \{\} <br /> |
