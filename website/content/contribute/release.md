...
For every stable release, including patches, add `website/content/releases/X.Y.Z.md` and update the highlighted
release and archive in `website/content/releases/_index.md`. These pages are maintained by hand; the docs build does
not generate them from GitHub Releases or `CHANGELOG.md`. Include the release highlights, upgrade guidance, and links
to the published artifacts and applicable migration procedures. Run `make docs-build` to validate the pages.
...
- `website/content/releases/X.Y.Z.md` and the release index for stable releases.
