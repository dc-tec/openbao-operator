...
| `Docs Build` | `make docs-build` | Strict Docusaurus build (`website/build/`) |
...
<Tabs groupId="smoke-full-helm-smoke-debug">

<TabItem value="smoke" label="Smoke">
...
<TabItem value="helm-smoke" label="Helm Smoke">
...
<Tabs groupId="govulncheck-dependency-licenses-trivy">

<TabItem value="govulncheck" label="Govulncheck">
...
<TabItem value="dependency-licenses" label="Dependency licenses">
...
<TabItem value="trivy" label="Trivy">

```sh
make security-scan IMG=ghcr.io/dc-tec/openbao-operator:edge
```

<Callout type="note" title="Expected RBAC findings">
