...
<Callout type="tip" title="Required Tools">
...
<Tabs groupId="local-development-fast-loop-cluster-deployment-integration-loop-tilt-fast-cluster-loop">

<TabItem value="local-development-fast-loop" label="Local Development (Fast Loop)">
...
<TabItem value="cluster-deployment-integration-loop" label="Cluster Deployment (Integration Loop)">
...
<TabItem value="tilt-fast-cluster-loop" label="Tilt (Fast Cluster Loop)">
...
<ExpandableCallout type="question" title="How do I confirm my workstation has everything required?">
...
<ExpandableCallout type="question" title="What does the Tilt workflow build?">
