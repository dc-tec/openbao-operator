...
<Tabs groupId="1-unit-tests-2-integration-envtest-3-end-to-end-e2e-4-manual-exploratory">

<TabItem value="1-unit-tests" label="1. Unit Tests">
...
<Callout type="warning" title="Golden File Review">
...
<TabItem value="2-integration-envtest" label="2. Integration (EnvTest)">
...
<Callout type="tip" title="Speed vs Fidelity">
...
<TabItem value="3-end-to-end-e2e" label="3. End-to-End (E2E)">
...
<Callout type="note" title="Cleanup behavior">
...
<TabItem value="4-manual-exploratory" label="4. Manual / Exploratory">
